...
my_colors_p1 <- c("#2291d1ff", "#0d4581ff")
my_colors_p2 <- c("#8b9faaff", "#2291d1ff", "#0d4581ff")
```
...
p1 = ggplot2::ggplot(
  ...
  ggplot2::ggtitle("no. of studies/credible sets")
...
p2 <- ggplot2::ggplot(
  ...
  ggplot2::ggtitle("Total no. of variants")
...
p3 <- ggplot2::ggplot(
  ...
  ggplot2::theme(axis.text.y = element_text(angle = 0, hjust = 0.5)) +
  ggplot2::scale_y_continuous(labels = scales::label_number(scale_cut = scales::cut_short_scale())) +
  ...
  ggplot2::ggtitle("no. of overlapping variants")
